...
const _ = () => {
	...
	// 사진보기
	const [photo, setPhoto] = useState(['/images/temp/temp-album.jpg', '/images/temp/temp-album.jpg', '/images/temp/temp-album.jpg'])
	const [popPhotoView, setPopPhotoView] = useState(false)
	const popOpenPhotoView = () => {
					...
					<div className='list-box'>
						<ul>
							...
							<li>
								발생시각
								<div className='right'>
									<span className='c-red'>2023.08.17 08:23:12</span>
								</div>
							</li>
						</ul>
					</div>
