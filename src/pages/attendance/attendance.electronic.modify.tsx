...
import { FILE_MAX_SIZE, globalStore } from '@/shared'
import { useEffect, useState } from 'react'
import Contents from './attendance.electionic.style'
				...
				<div className='electronic-attendance-modify-wrap'>
					...
					<div className='electronic-attendance-modify-section'>
						...
						<div className='tag-info-regist'>
							...
							<UploadFiles files={files} max={FILE_MAX_SIZE} onChange={setFiles} placeholder='태그 정보 파일 등록' />
						</div>
