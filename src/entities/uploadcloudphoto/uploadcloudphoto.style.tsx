...
export const UploadCloudPhoto = styled.div`
	...
	.analyze-photo {
		...
		> ul > li {
			...
			.photos {
				...
				.thumb {${Thumb} width: 7.2rem; height: 7.2rem; margin-right: 1.6rem; border-radius: 1rem; margin-right: 1.6rem; position: relative; overflow: hidden;
